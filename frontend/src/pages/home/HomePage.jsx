            ...
            <section className="mt-12 w-full max-w-2xl">
              ...
              <div className="mt-4 rounded-2xl border border-green-200 bg-white shadow-lg p-6">
                <p className="leading-8 text-center text-gray-600 text-sm">
                  ...
                  is an interactive mathematics learning platform designed to
                  help learners build confidence through consistent practice and
                  engaging challenges. Whether you're strengthening fundamental
                  concepts or preparing for examinations, iMath provides a
                  simple, focused, and effective environment to improve your
                  mathematical skills at your own pace.
                </p>
              </div>
            </section>
          </main>
